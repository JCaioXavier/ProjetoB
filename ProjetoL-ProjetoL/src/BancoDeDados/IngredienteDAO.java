...
public class IngredienteDAO {
    public static void ingredientesDAO() {
        String sql = "SELECT id_ingrediente, nome_ingrediente, estoque FROM piramide.ingredientes ORDER BY id_ingrediente ASC";
    ...
    public static int pegarIngredienteDAO() {
        ...
        do {
            ...
            String sql = "SELECT nome_ingrediente, estoque FROM piramide.ingredientes WHERE id_ingrediente = ?";
    ...
    public static void inserirIngredienteDAO(Ingrediente novo) {
        ...
        String sql = "INSERT INTO piramide.ingredientes (nome_ingrediente, estoque) VALUES (?, ?)";
    ...
    public static void checkadordeIngredientesDAO(Ingrediente novoIngrediente ) {
        ...
        do {
            ...
            String sql = "SELECT nome_ingrediente FROM piramide.ingredientes WHERE nome_ingrediente = ?";
    ...
    public static void updateIngredienteDAO(Ingrediente update) {
        ...
        String sql = "UPDATE piramide.ingredientes SET nome_ingrediente = ?, estoque = ? WHERE id_ingrediente = " + idi;
